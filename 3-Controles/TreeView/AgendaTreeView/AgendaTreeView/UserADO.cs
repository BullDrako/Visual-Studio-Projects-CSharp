    ...
    {/// <summary>
     ...
     /// <returns></returns>
        ...
        public Users searchField(String field)
        {
            ...
            {
                if (user.Mobil1 == Convert.ToInt32(mobil) || user.Nom.Equals(field))
        ...
        public Users deleteUser(Users searchedUsers)
        {
            ...
            foreach (User user in AllUsers)
            {
                ...
                {
                    if (user.Mobil1 != searched.Mobil1) newUsers.Add(user);
        ...
        public int saveAllFile()
        {
            ...
            try
            {
                ...
                {
                    counter++;
                    sw.WriteLine(user.Nom + ":" + user.Congoms + ":" + user.Mobil1 + ":" + user.Mobil2 + ":" + user.Telefono + ":" + user.Email + ":" + user.Uf);
                }
