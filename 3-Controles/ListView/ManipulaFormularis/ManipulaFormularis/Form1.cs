...
namespace ManipulaFormularis
{
    public partial class Form1 : Form
    {
        ...
        private void carrega(String fileName)
        {
            ...
            using (StreamReader reader = new StreamReader("manipula.txt", false))
            {
                string line;
        ...
        private void carregaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            openFileDialog1.InitialDirectory = "F:\\_CFGS\\CFGS DAM\\M7\\Controls\\ListView\\ManipulaFormularis\\ManipulaFormularis\\bin\\Debug";
        ...
        private void EliminarContacto(object sender, EventArgs e)
        {
            ...
            /* ListViewItem treb = listView1.SelectedItems[0];
             treb.SubItems[0].Text = "";
             treb.SubItems[1].Text = "";
             treb.SubItems[2].Text = "";
             treb.SubItems[3].Text = "";
             treb.SubItems[4].Text = "";
             treb.SubItems[5].Text = "";
             treb.SubItems[6].Text = "";*/
...
//to do
            ...
            FormModificarContactoListView formMod = new FormModificarContactoListView();
