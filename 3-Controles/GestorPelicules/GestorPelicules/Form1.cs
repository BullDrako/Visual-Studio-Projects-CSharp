    ...
    public partial class Form1 : Form
    {
        ...
        private void actualitzarToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                /*string str2 = Convert.ToString(node);
                ...
                /*string str2 = Convert.ToString(EncontrarPelicula(a));
                MessageBox.Show(str2);*/
            ...
            /* foreach (Pelicula p in peliculas)
             {
                 ...
                 foreach (Pelicula peli in peliculas)
                 {
                     ...
                     lVI.SubItems.Add(peli.getTitol());
                     lVI.SubItems.Add(peli.getDirector());
                     lVI.SubItems.Add(peli.getActorsPrincipals());
                     lVI.SubItems.Add(peli.getPais());
                     lVI.SubItems.Add(peli.getAny());
                     lVI.SubItems.Add(peli.getDurada());
                     //index++;
                 }
             }*/
