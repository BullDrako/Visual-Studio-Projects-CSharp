...
namespace Exercici_basic_II_11
{
    /*
     10. Demanem un texte. Un cop introduït el programa ens hi deixarà fer diferentes accions a escollir en un menú:
        ...
        11. Feu el mateix exercici anterior però el texte provindrà d'un arxiu de texte.
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                String texto, btexto, cadena;
                int cont = 0, marcar_espacios;

                Console.WriteLine("El texto es: ");

                using (StreamReader sr = new StreamReader("Lectura.txt"))
                {
